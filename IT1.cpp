...
// IT1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CIT1App, CWinApp)
...
// Единственный объект CIT1App

CIT1App theApp;


// Инициализация CIT1App

BOOL CIT1App::InitInstance()
{
